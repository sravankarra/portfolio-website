...
- Keep secrets in `.env` locally, or in your host's environment variables when you deploy
- Do not commit `.env`, `admin_auth.json`, or `.secret_key`
- Copy `.env.example` for the required variable names, then add your own values
- The public contact email on the portfolio page is separate from the private mail login used to send reset emails
